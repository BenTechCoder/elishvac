...
<section class="uppercase font-display text-step-3 md:text-step-4 lg:text-step-5 2xl:text-step-6 break-words">
    <div class="py-m-l bg-secondary text-background intersect-once intersect:motion-translate-x-in-100">
    ...
    <div class="py-m-l bg-tertiary text-background text-center intersect-once intersect:motion-translate-x-in-100">
