<section class="py-xl gutter">
    <div class="cta-about sidebar items-center" style="--sidebar-basis:60ch;">
        <img class="cta-about__img" src="<?php echo get_parent_theme_file_uri("/assets/images/about-cropped.webp") ?>" alt="">
        <article class="cta-about__content stack lg:text-center">
            <h2><?php echo strtoupper("YOUR TRUSTED EASTERN NORTH CAROLINA HVAC EXPERTS"); ?></h2>
            <ul class="stack">
